...
$business_eye_customizer_defaults['business-eye-default-banner-image'] = '';
...
$business_eye_settings_controls['business-eye-enable-static-page'] =
    ...
    /*creating setting control for business-eye-layout-options start*/
    $business_eye_settings_controls['business-eye-default-banner-image'] =
        array(
            'setting' =>     array(
                'default'              => $business_eye_customizer_defaults['business-eye-default-banner-image'],
            ),
            'control' => array(
                'label'                 =>  __( 'Default Banner Image', 'business-eye' ),
                'description'           =>  __( 'Please note that if you remove this image default banner image will appear', 'business-eye' ),
                'section'               => 'business-eye-layout-options',
                'type'                  => 'image',
                'priority'              => 10,
            )
